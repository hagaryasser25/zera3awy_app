...
class FarmLogin extends StatefulWidget {
  static const routeName = '/farmLogin';
  const FarmLogin({super.key});

  @override
  State<FarmLogin> createState() => _FarmLoginState();
}

class _FarmLoginState extends State<FarmLogin> {
                    ...
                    onPressed: () async {
                      ...
                      try {
                        ...
                        if (userCredential.user != null) {
                          ...
                          Navigator.pushReplacementNamed(context, FarmHome.routeName);
                        }
